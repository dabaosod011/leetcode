...
BOOST_AUTO_TEST_SUITE( mobile_number_Keyboard_test )
	...
	{	
		...
		BOOST_ASSERT( getCountInPosition(1) == 10 );
		BOOST_ASSERT( getCountInPosition(2) == 36 );
		BOOST_ASSERT( getCountInPosition(3) == 138 );
		BOOST_ASSERT( getCountInPosition(4) == 532 );
		BOOST_ASSERT( getCountInPosition(5) == 2062 );
	}
